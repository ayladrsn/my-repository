...
from flask import Flask , redirect, render_template , url_for , render_template
...
@app.route("/")
def home():
    return 'This is home page for no path, <h1> Welcome Clarusway </h1>'
...
@app.route('/error')
def error():
    return '<h1> Either you encountered an error or you ere not authorized.</h1>'
...
@app.route('/list10')
def list10():
    return render_template('list10.html', interval=range(1,11))
